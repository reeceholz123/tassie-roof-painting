/* ============================================================
   Tassie Roof Painting — main.js
   Single IIFE. Behaviours wired per the rebuild spec.
   ============================================================ */
(function () {
  'use strict';

  console.info('Tassie Roof Painting · site script v1');
  ...
  if (heroImg) {
    heroImg.addEventListener('load', () => {
      if (heroImg.naturalWidth < 1600) {
        console.warn('Tassie Roof Painting: hero image <1600px wide — supply a larger source for sharper rendering.');
      }
    });
  }
